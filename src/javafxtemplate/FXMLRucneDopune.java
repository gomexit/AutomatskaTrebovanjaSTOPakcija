 ...
 * @author laki
 */
public class FXMLRucneDopune implements Initializable {
    ...
    @FXML   TableView tbl_lista_akcija; 
          ...
          TableColumn<BVMpAkcRucneDopune,Integer> RP_ID;  
          TableColumn<BVMpAkcRucneDopune,Integer> RP_ID_AKCIJE; 
          TableColumn<BVMpAkcRucneDopune,String> RP_ID_KAMPANJE;  
          TableColumn<BVMpAkcRucneDopune,Long> RP_ID_ARTIKAL;  
          TableColumn<BVMpAkcRucneDopune,String> RP_SIFRA_ARTIKLA;
          TableColumn<BVMpAkcRucneDopune,String> RP_NAZIV_ARTIKLA;  
          TableColumn<BVMpAkcRucneDopune,String> RP_ORGJED;
          TableColumn<BVMpAkcRucneDopune,String> RP_NAZIV_ORGJEDA; 
          TableColumn<BVMpAkcRucneDopune,BigDecimal> RP_KOLICINA; 
          TableColumn<BVMpAkcRucneDopune,Date> RP_SIS_DATUM;
           ObservableList<BVMpAkcRucneDopune> RP_data1;
          ...
          if ( proveriPodatke().equals("OK"))
                            {
                                                              ...
                                                              Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
                                                              alert1.setTitle("Information Dialog");
                                                              alert1.setHeaderText("Unos rucne dopune!");
                                                              alert1.setContentText("Uneli ste rucnu dopunu. Na sledcem tabu pogledajete analitiku");
                                                              alert1.showAndWait();
                                                              prikaziTabeluArtikliOrgjedIskljuceni();
...
@FXML
       ...
       @FXML
       public void obracunajRucneDopune () {
          ...
          if ( proveriPodatke2().equals("OK"))
                            {
                                                            ...
                                                            */                                                                           
                                                              ...
                                                              em.getTransaction().begin();
                                                              StoredProcedureQuery storedprocedure1 = em.createStoredProcedureQuery("rouser.b_mp_akc_unesi_rucne_dopune");
                                                              ...
                                                              alert1.setTitle("Information Dialog");
                                                              alert1.setHeaderText("Unos rucne dopune!");
                                                              alert1.setContentText("Uneli ste rucnu dopune");
                                                              alert1.showAndWait();
                                                              prikaziTabeluArtikliOrgjedIskljuceni();
  ...
  public void prikaziRucneDopune() {
 
     em.clear();
        List<BVMpAkcRucneDopune>  results =  em.createNamedQuery("BVMpAkcRucneDopune.findById")
              .setParameter("id", AK_data.get(tbl_lista_akcija.getSelectionModel().getSelectedIndex()).getId())
              .setHint(QueryHints.MAINTAIN_CACHE, "false")
                .getResultList();
                
                
          RP_data1 = FXCollections.observableArrayList(results);
          
          System.out.println("Tekst je: " + RP_data1.toString());
          ...
          tbl_V_pregled_ARIOJ.setItems(RP_data1);
          ...
          if ( proveriPodatke3().equals("OK"))
                            {
                                                            ...
                                                            */                                                                           
                                                              ...
                                                              em.getTransaction().begin();
                                                              StoredProcedureQuery storedprocedure1 = em.createStoredProcedureQuery("rouser.b_mp_akc_rucne_dopune_izmen");

                                                              storedprocedure1.registerStoredProcedureParameter("P_ID", Integer.class, ParameterMode.IN);
                                                              storedprocedure1.setParameter("P_ID",AK_data.get(tbl_lista_akcija.getSelectionModel().getSelectedIndex()).getId());

                                                              storedprocedure1.registerStoredProcedureParameter("P_ARTIKAL", Integer.class, ParameterMode.IN);
                                                              storedprocedure1.setParameter("P_ARTIKAL",RP_data1.get(tbl_V_pregled_ARIOJ.getSelectionModel().getSelectedIndex()).getArtikal());

                                                              storedprocedure1.registerStoredProcedureParameter("P_ORGJED", String.class, ParameterMode.IN);
                                                              storedprocedure1.setParameter("P_ORGJED",RP_data1.get(tbl_V_pregled_ARIOJ.getSelectionModel().getSelectedIndex()).getOrgjed());
                                                              ...
                                                              Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
                                                              alert1.setTitle("Information Dialog");
                                                              alert1.setHeaderText("Korekcija rucne dopune!");
                                                              alert1.setContentText("Korigovali ste rucnu dopunu");
                                                              alert1.showAndWait();
                                                              prikaziTabeluArtikliOrgjedIskljuceni();
