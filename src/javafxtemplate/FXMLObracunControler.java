 ...
 * @author bojan
 */
public class FXMLObracunControler implements Initializable {
    ...
    //----------------------------------------
     ...
     ObservableList<BVMpAkcPreporKol> PK_data; 
    ...
    //kolone za preporucene kolicine po osnovnom algoritmu
       TableColumn<BVMpAkcPreporKol,Integer> PK_ID;
       TableColumn<BVMpAkcPreporKol,Long> PK_ID_AKCIJE;
       TableColumn<BVMpAkcPreporKol,String> PK_ID_KAMPANJE;
       TableColumn<BVMpAkcPreporKol,String> PK_ORGJED;
       TableColumn<BVMpAkcPreporKol,String> PK_NAZIV_ORGJED;
       TableColumn<BVMpAkcPreporKol,Long> PK_ARTIKAL;
       TableColumn<BVMpAkcPreporKol,String> PK_SIFRA;
       TableColumn<BVMpAkcPreporKol,String> PK_NAZIV;
   ...
   TableColumn<BVMpAkcArtikStop,String> ART_STOP_NAZIV;
    ...
    public void listaRazvozaDopuna(Integer i,String s) {
     ...
     public void listaPreporKol(Integer i) {
        em.clear();
          List<BVMpAkcPreporKol>  results =  em.createNamedQuery("BVMpAkcPreporKol.findById")
                  .setParameter("id", i)
                  .getResultList();
          ...
          PK_ID.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKol,Integer>("id"));
          ...
          PK_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKol,String>("orgjed"));
          
          PK_NAZIV_ORGJED=new TableColumn ("PK_NAZIV_ORGJED");
          PK_NAZIV_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKol,String>("nazivOrgjed"));
          
          PK_ARTIKAL=new TableColumn ("PK_ARTIKAL");
          PK_ARTIKAL.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKol,Long>("artikal"));
          
          PK_SIFRA=new TableColumn ("PK_SIFRA");
          PK_SIFRA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKol,String>("sifra"));
          
          PK_NAZIV=new TableColumn ("PK_NAZIV");
          PK_NAZIV.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKol,String>("naziv"));
     ...
     public void listaPreporKolFilter() {
       ...
       String v_cmb_radnja;
        ...
        // v_id_artikla=Long.valueOf("-1");
        em.clear();
          List<BVMpAkcPreporKol>  results =  em.createNamedQuery("BVMpAkcPreporKol.filterPretraga")
     ...
     public void listaPreporKol2(Integer i, String s) {
        em.clear();
          List<BVMpAkcPreporKol>  results =  em.createNamedQuery("BVMpAkcPreporKol.poOJiID")
                  .setParameter("id", i)
    ...
    public void listaAlgoritama(Integer i) {
     ...
     public void pretragaDopunskihTrebovanja () 
     {
         ...
         try {
          ...
          List<BVMpAkcDopunskaTrebovanja>  results =  em.createNamedQuery("BVMpAkcDopunskaTrebovanja.Pretraga")
                  .setParameter("id", data.get(tabela.getSelectionModel().getSelectedIndex()).getId())
    ...
    System.out.println("greska je opsta: "+ex.getMessage());
     ...
     public void kreirajExcelDopuna() {
         ...
         try {
          ...
          List<BVMpAkcDopunskaTrebovanja>  results_excel =  em.createNamedQuery("BVMpAkcDopunskaTrebovanja.Pretraga")
                  .setParameter("id", data.get(tabela.getSelectionModel().getSelectedIndex()).getId())
                  .setParameter("nazivArtikla", "%"+DT_P_naziv_artikla.getText().toUpperCase()+"%")
                  .setParameter("sifra","%"+ DT_P_sifra.getText()+"%")
                  .setParameter("datOd", date1)
        ...
        if ((tabela.getSelectionModel().getSelectedIndex()>-1)  )
            {
                   ...
                   List<BMpAkcije> b  =  em.createNamedQuery( "BMpAkcije.findById")
                    ...
                    Date datumPocetkaAkcije;
                    DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd.MM.yyyy");
                    LocalDate datumOdAkcije = LocalDate.parse(b.get(0).getDatumOd(), dtf);
                    LocalDate danasnjiDatum = now();
                    long daysBetween = DAYS.between(danasnjiDatum, datumOdAkcije);
                    int otkljucavanje_broj_dana_pre_pocetka = 3;
                    if (daysBetween < otkljucavanje_broj_dana_pre_pocetka){
                        JOptionPane.showMessageDialog(null, "Akciju mozete otvoriti najkasnije "+otkljucavanje_broj_dana_pre_pocetka+" dana pre pocetka!");
                        return;
                    }
                    if (!b.isEmpty())
                    {
                        try {
                             if ((b.get(0).getStatus().equals("Z")))
                                 {      
                                     b.get(0).setStatus("R");
                                     em.getTransaction().commit();
                                     List<BMpAkcije>  results =  em.createNamedQuery("BMpAkcije.findAll").getResultList();
                                     ...
                                     alert.setContentText("Otvorili ste akciju"); 
                                     alert.showAndWait();  
                                 }  
