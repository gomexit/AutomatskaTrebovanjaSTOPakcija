 ...
 * @author bojan
 */
public class FXMLObracunControler_arhiva implements Initializable {
    ...
    //----------------------------------------
     ...
     ObservableList<BVMpAkcPreporKolArh> PK_data; 
     ObservableList<BVMpAkcPreporKolTemArh> PKT_data; 
     ObservableList<BVMpAkcDopunskaTreboArh> DT_data;
     ...
     ObservableList<BVMpAkcTrebovanjeArh> PP_data; //pregled prvog punjenja
    ...
    //kolone za preporucene kolicine po osnovnom algoritmu
       TableColumn<BVMpAkcPreporKolArh,Integer> PK_ID;
       TableColumn<BVMpAkcPreporKolArh,Long> PK_ID_AKCIJE;
       TableColumn<BVMpAkcPreporKolArh,String> PK_ID_KAMPANJE;
       TableColumn<BVMpAkcPreporKolArh,String> PK_ORGJED;
       TableColumn<BVMpAkcPreporKolArh,String> PK_NAZIV_ORGJED;
       TableColumn<BVMpAkcPreporKolArh,Long> PK_ARTIKAL;
       TableColumn<BVMpAkcPreporKolArh,String> PK_SIFRA;
       TableColumn<BVMpAkcPreporKolArh,String> PK_NAZIV;
       TableColumn<BVMpAkcPreporKolArh,Integer> PK_PRIMENJEN_ALGORITAM;
       TableColumn<BVMpAkcPreporKolArh,String> PK_OPIS;
       TableColumn<BVMpAkcPreporKolArh,BigDecimal> PK_PREPORUCENA;
       TableColumn<BVMpAkcPreporKolArh,BigDecimal> PK_PREPOR_BEZ_KOEF;
       TableColumn<BVMpAkcPreporKolArh,BigDecimal> PK_CENA;
       TableColumn<BVMpAkcPreporKolArh,String> PK_ROBNA_GRUPA;
    ...
    //kolone za analitiku prepor temp
     //kolone za preporucene kolicine po osnovnom algoritmu
       TableColumn<BVMpAkcPreporKolTemArh,Integer> PKT_ID;
       TableColumn<BVMpAkcPreporKolTemArh,Long> PKT_ID_AKCIJE;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_ID_KAMPANJE;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_ORGJED;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_NAZIV_ORGJED;
       TableColumn<BVMpAkcPreporKolTemArh,Long> PKT_ARTIKAL;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_SIFRA;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_NAZIV;
       TableColumn<BVMpAkcPreporKolTemArh,Integer> PKT_PRIMENJEN_ALGORITAM;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_OPIS;
       TableColumn<BVMpAkcPreporKolTemArh,BigDecimal> PKT_PREPORUCENA;
       TableColumn<BVMpAkcPreporKolTemArh,BigDecimal> PKT_PREPOR_BEZ_KOEF;
       TableColumn<BVMpAkcPreporKolTemArh,BigDecimal> PKT_CENA;
       TableColumn<BVMpAkcPreporKolTemArh,String> PKT_ROBNA_GRUPA;
    
    @FXML TextArea txtAreaOpisAnalitika;
    
    //kolone za tabelu dopunska trebovanja
       TableColumn<BVMpAkcDopunskaTreboArh,String> DT_ORGJED;
       TableColumn<BVMpAkcDopunskaTreboArh,String> DT_RADNJA;
       TableColumn<BVMpAkcDopunskaTreboArh,Long> DT_ID_ARTIKLA;
       TableColumn<BVMpAkcDopunskaTreboArh,String> DT_SIFRA;
       TableColumn<BVMpAkcDopunskaTreboArh,String> DT_NAZIV_ARTIKLA;
       TableColumn<BVMpAkcDopunskaTreboArh,Integer> DT_BROJ_DOPUNE;    
       TableColumn<BVMpAkcDopunskaTreboArh,String> DT_MAGACIN;
       TableColumn<BVMpAkcDopunskaTreboArh,Date> DT_DATUM;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_MULTIFAKTOR;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_ZALIHA;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_PRODAJA;
       TableColumn<BVMpAkcDopunskaTreboArh,Date> DT_DATUM_ZALIHE;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_PREPOR_KOL_DO_ISPORUKE;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_PREPOR_KOL_PERIOD;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_NESREDJENA_KOLICINA;
       TableColumn<BVMpAkcDopunskaTreboArh,BigDecimal> DT_SREDJENA_KOLCINA;
       TableColumn<BVMpAkcDopunskaTreboArh,Date> DT_PROJEKCIJA_OD;
       TableColumn<BVMpAkcDopunskaTreboArh,Date> DT_PROJEKCIJA_DO;
   // @FXML   TableColumn<BVMpAkcDopunskaTrebovanja,String> DT_OPIS;
       TableColumn<BVMpAkcDopunskaTreboArh,String> DT_RG_ROOT;
   ...
   // @FXML ListView<String> listaRadnji;
    ...
    @FXML TextField PP_P_naziv_artikla;
       ...
       TableColumn<BVMpAkcTrebovanjeArh,Integer> PP_ID;
       TableColumn<BVMpAkcTrebovanjeArh,Long> PP_ID_AKCIJE;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_ID_KAMPANJE;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_ORGJED;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_NAZIV_ORGJED;
       TableColumn<BVMpAkcTrebovanjeArh,Long> PP_ARTIKAL;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_SIFRA;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_NAZIV;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_OPIS;
       TableColumn<BVMpAkcTrebovanjeArh,String> PP_MAGACIN;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_SREDJENA_KOL;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_MULTIFAKTOR;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_SEK_POZICIJA;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_NABAVLJAM_KOL;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_PREPORUCENA_KOL_UK;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_PREPORUCENA_KOL;
       TableColumn<BVMpAkcTrebovanjeArh,BigDecimal> PP_ZALIHA;
       TableColumn<BVMpAkcTrebovanjeArh,Date> PP_DATUM;
       
       
       @FXML TableView tbl_artikli_stop;
   ...
   TableColumn<BVMpAkcArtikStop,String> ART_STOP_NAZIV;
     ...
     //izmena matrice dopuna
      ...
      @FXML Label br_redova1;
      @FXML Label br_redova2;
    ...
    public void changed(ObservableValue observableValue, Object oldValue, Object newValue) {
       ...
       //    listaPreporKol(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
          ...
          // listaRadnji2(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           listaMagacina(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           listaDopuna(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           listaAlgoritama(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           listaNedostajuci(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           listaErrorLog(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           listaRadnjiPrvoPunjenje(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
           prikaziArtikleStop(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
    ...
    public void listaRazvozaDopuna(Integer i,String s) {
        em.clear();
          List<BVMpAkcMatricaRazvozaDop>  results =  em.createNamedQuery("BVMpAkcMatricaRazvozaDop.findByIdiNazivOJ")
                  .setParameter("id", i)
     ...
     public void listaPreporKol(Integer i) {
        em.clear();
          List<BVMpAkcPreporKolArh>  results =  em.createNamedQuery("BVMpAkcPreporKolArh.findById")
                  .setParameter("id", i)
                  .getResultList();
                 
                    int a = results.size();
                    br_redova1.setText( "Br. redova je :" +a); 
          
          PK_data = FXCollections.observableArrayList(results);
          
           
          PK_ID=new TableColumn ("PK_ID");
          PK_ID.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,Integer>("id"));
          
          PK_ID_AKCIJE=new TableColumn ("PK_ID_AKCIJE");
          PK_ID_AKCIJE.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,Long>("idAkcije"));
          
          PK_ID_KAMPANJE=new TableColumn ("PK_ID_KAMPANJE");
          PK_ID_KAMPANJE.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("idKampanje"));
          
          PK_ORGJED=new TableColumn ("PK_ORGJED");
          PK_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("orgjed"));
          
          PK_NAZIV_ORGJED=new TableColumn ("PK_NAZIV_ORGJED");
          PK_NAZIV_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("nazivOrgjed"));
          
          PK_ARTIKAL=new TableColumn ("PK_ARTIKAL");
          PK_ARTIKAL.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,Long>("artikal"));
          
          PK_SIFRA=new TableColumn ("PK_SIFRA");
          PK_SIFRA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("sifra"));
          
          PK_NAZIV=new TableColumn ("PK_NAZIV");
          PK_NAZIV.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("naziv"));
          
          PK_PRIMENJEN_ALGORITAM=new TableColumn ("PK_PRIMENJEN_ALGORITAM");
          PK_PRIMENJEN_ALGORITAM.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,Integer>("primenjenAlgoritam"));
          
          PK_OPIS=new TableColumn ("PK_OPIS");
          PK_OPIS.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("opis"));
          
          PK_PREPORUCENA=new TableColumn ("PK_PREPORUCENA");
          PK_PREPORUCENA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,BigDecimal>("preporucena"));
          
          PK_PREPOR_BEZ_KOEF=new TableColumn ("PK_PREPOR_BEZ_KOEF");
          PK_PREPOR_BEZ_KOEF.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,BigDecimal>("preporBezKoef"));
          
          PK_CENA=new TableColumn ("PK_CENA");
          PK_CENA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,BigDecimal>("cena"));
          
          PK_ROBNA_GRUPA=new TableColumn ("PK_ROBNA_GRUPA");
          PK_ROBNA_GRUPA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolArh,String>("robnaGrupa"));
     ...
     public void listaPreporKolFilter() {
       ...
       String v_cmb_radnja;
        ...
        // v_id_artikla=Long.valueOf("-1");
        em.clear();
          List<BVMpAkcPreporKolArh>  results =  em.createNamedQuery("BVMpAkcPreporKolArh.filterPretraga")
                 ...
                 int i = results.size();
               br_redova1.setText( "Br. redova je :" +i); 
     ...
     public void listaPreporKol2(Integer i, String s) {
        em.clear();
          List<BVMpAkcPreporKolArh>  results =  em.createNamedQuery("BVMpAkcPreporKolArh.poOJiID")
                  .setParameter("id", i)
     ...
     //SADA  za analitiku
      public void listaPreporKolTemp(Integer i) {
        ...
        Integer v_id; String v_sifra,v_orgjed;
      //  data.get(tabela.getSelectionModel().getSelectedIndex()).getId()
        ...
        v_orgjed=PK_data.get(tblPreporKol.getSelectionModel().getSelectedIndex()).getOrgjed();
          ...
          List<BVMpAkcPreporKolTemArh>  results =  em.createNamedQuery("BVMpAkcPreporKolTemArh.findById")
          ...
          PKT_ID.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,Integer>("id"));
          
          PKT_ID_AKCIJE=new TableColumn ("PKT_ID_AKCIJE");
          PKT_ID_AKCIJE.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,Long>("idAkcije"));
          PKT_ID_AKCIJE.setPrefWidth(90);
          PKT_ID_AKCIJE.setText("id akcije"); 
          
          PKT_ID_KAMPANJE=new TableColumn ("PKT_ID_KAMPANJE");
          PKT_ID_KAMPANJE.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("idKampanje"));
          PKT_ID_KAMPANJE.setPrefWidth(90);
          PKT_ID_KAMPANJE.setText("id kampanje"); 
          
          PKT_ORGJED=new TableColumn ("PKT_ORGJED");
          PKT_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("orgjed"));
          PKT_ORGJED.setPrefWidth(30);
          PKT_ORGJED.setText("OJ"); 
          
          PKT_NAZIV_ORGJED=new TableColumn ("PKT_NAZIV_ORGJED");
          PKT_NAZIV_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("nazivOrgjed"));
          PKT_NAZIV_ORGJED.setPrefWidth(120);
          PKT_NAZIV_ORGJED.setText("OJ naziv"); 
          
          PKT_ARTIKAL=new TableColumn ("PKT_ARTIKAL");
          PKT_ARTIKAL.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,Long>("artikal"));
          PKT_ARTIKAL.setPrefWidth(60);
          PKT_ARTIKAL.setText("id artikla"); 
          
          PKT_SIFRA=new TableColumn ("PKT_SIFRA");
          PKT_SIFRA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("sifra"));
          PKT_SIFRA.setPrefWidth(60);
          PKT_SIFRA.setText("sifra art");
          
          PKT_NAZIV=new TableColumn ("PKT_NAZIV");
          PKT_NAZIV.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("naziv"));
          PKT_NAZIV.setPrefWidth(200);
          PKT_NAZIV.setText("naziv artikla");
           
          PKT_PRIMENJEN_ALGORITAM=new TableColumn ("PKT_PRIMENJEN_ALGORITAM");
          PKT_PRIMENJEN_ALGORITAM.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,Integer>("primenjenAlgoritam"));
          PKT_PRIMENJEN_ALGORITAM.setPrefWidth(60);
          PKT_PRIMENJEN_ALGORITAM.setText("algoritam");
          
          PKT_OPIS=new TableColumn ("PKT_OPIS");
          PKT_OPIS.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("opis"));
          
          PKT_PREPORUCENA=new TableColumn ("PKT_PREPORUCENA");
          PKT_PREPORUCENA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,BigDecimal>("preporucena"));
          ...
          PKT_PREPOR_BEZ_KOEF.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,BigDecimal>("preporBezKoef"));
          PKT_PREPOR_BEZ_KOEF.setPrefWidth(120);
          PKT_PREPOR_BEZ_KOEF.setText("prepor bez koef");
          
          PKT_CENA=new TableColumn ("PKT_CENA");
          PKT_CENA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,BigDecimal>("cena"));
          PKT_CENA.setPrefWidth(85);
          PKT_CENA.setText("cena");
     
          PKT_ROBNA_GRUPA=new TableColumn ("PKT_ROBNA_GRUPA");
          PKT_ROBNA_GRUPA.setCellValueFactory(new PropertyValueFactory<BVMpAkcPreporKolTemArh,String>("robnaGrupa"));
     ...
     public void listaRadnji(Integer i) {
           em.clear();
          List<String>  results =  em.createNamedQuery("BVMpAkcPreporKolArh.razliciteRadnje")
                  .setParameter("id", i)
                  .getResultList();
    ...
    public void listaAlgoritama(Integer i) {
           em.clear();
          List<Integer>  results =  em.createNamedQuery("BVMpAkcPreporKolArh.Algoritmi")
                  .setParameter("id", i)
                  .getResultList();
     ...
     public void listaMagacina(Integer i) {
      /*     em.clear();
          ...
          */
          List<String> listAnalitika = new ArrayList<String>();
        listAnalitika.add("131");
        listAnalitika.add("138");               
        listAnalitika.add("139");
        ObservableList obList2 = FXCollections.observableList(listAnalitika);
        DT_P_MAGACIN.getItems().clear();
        DT_P_MAGACIN.setItems(obList2);
      ...
      public void listaDopuna(Integer i) {
        ...
        */
        ...
        listAnalitika.add("7");
        listAnalitika.add("8");               
        listAnalitika.add("21");
        listAnalitika.add("22");
        listAnalitika.add("23");               
        listAnalitika.add("24");
        listAnalitika.add("25");
        ObservableList obList2 = FXCollections.observableList(listAnalitika);
        DT_P_broj_dopune.getItems().clear();
        DT_P_broj_dopune.setItems(obList2);
     ...
     public void pretragaDopunskihTrebovanja () 
     {
         ...
         try {
          ...
          List<BVMpAkcDopunskaTreboArh>  results =  em.createNamedQuery("BVMpAkcDopunskaTreboArh.Pretraga")
                  .setParameter("id", data.get(tabela.getSelectionModel().getSelectedIndex()).getId())
                  ...
                  int i = results.size();
               br_redova2.setText( "Br. redova je :" +i); 
             
          DT_data = FXCollections.observableArrayList(results);       
  
          DT_ID_ARTIKLA=new TableColumn ("DT_ID_ARTIKLA");
          DT_ID_ARTIKLA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,Long>("idArtikla"));
          DT_ID_ARTIKLA.setPrefWidth(80);
          DT_ID_ARTIKLA.setText("id artikla"); 
          
          DT_BROJ_DOPUNE=new TableColumn ("DT_BROJ_DOPUNE");
          DT_BROJ_DOPUNE.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,Integer>("brojDopune"));
          DT_BROJ_DOPUNE.setPrefWidth(80);
          DT_BROJ_DOPUNE.setText("dopuna");
        
          DT_ORGJED=new TableColumn ("DT_ORGJED");
          DT_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,String>("orgjed"));
          DT_ORGJED.setPrefWidth(30);
          DT_ORGJED.setText("OJ");
                  
          
          DT_RADNJA=new TableColumn ("DT_RADNJA");
          DT_RADNJA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,String>("radnja"));
          DT_RADNJA.setPrefWidth(120);
          DT_RADNJA.setText("OJ naziv"); 
          
          DT_SIFRA=new TableColumn ("DT_SIFRA");
          DT_SIFRA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,String>("sifra"));
          DT_SIFRA.setPrefWidth(80);
          DT_SIFRA.setText("šifra artikla"); 
          
          DT_NAZIV_ARTIKLA=new TableColumn ("DT_NAZIV_ARTIKLA");
          DT_NAZIV_ARTIKLA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,String>("nazivArtikla"));
          DT_NAZIV_ARTIKLA.setPrefWidth(200);
          DT_NAZIV_ARTIKLA.setText("naziv artikla");
                  
          DT_MAGACIN=new TableColumn ("DT_MAGACIN");
          DT_MAGACIN.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,String>("magacin"));
          DT_MAGACIN.setPrefWidth(30);
          DT_MAGACIN.setText("DC");
          
          DT_DATUM=new TableColumn ("DT_DATUM");
          DT_DATUM.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,Date>("datum"));
          DT_DATUM.setPrefWidth(80);
          DT_DATUM.setText("datum");
          
          DT_MULTIFAKTOR=new TableColumn ("DT_MULTIFAKTOR");
          DT_MULTIFAKTOR.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("multifaktor"));
          DT_MULTIFAKTOR.setPrefWidth(30);
          DT_MULTIFAKTOR.setText("MF");
          
          DT_ZALIHA=new TableColumn ("DT_ZALIHA");
          DT_ZALIHA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("zaliha"));
          DT_ZALIHA.setPrefWidth(60);
          DT_ZALIHA.setText("zaliha");
          
          DT_PRODAJA=new TableColumn ("DT_PRODAJA");
          DT_PRODAJA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("prodaja"));
          DT_PRODAJA.setPrefWidth(60);
          DT_PRODAJA.setText("prodaja");
         
          DT_DATUM_ZALIHE=new TableColumn ("DT_DATUM_ZALIHE");
          DT_DATUM_ZALIHE.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,Date>("datumZalihe"));
          ...
          DT_PREPOR_KOL_DO_ISPORUKE.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("preporKolDoIsporuke"));
          ...
          DT_PREPOR_KOL_PERIOD.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("preporKolPeriod"));
          ...
          DT_NESREDJENA_KOLICINA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("nesredjenaKolicina"));
          ...
          DT_SREDJENA_KOLCINA.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,BigDecimal>("sredjenaKolicina"));
          ...
          DT_PROJEKCIJA_OD.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,Date>("projekcijaOd"));
          ...
          DT_PROJEKCIJA_DO.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,Date>("projekcijaDo"));
          DT_PROJEKCIJA_DO.setPrefWidth(120);
          DT_PROJEKCIJA_DO.setText("dat_projekcije_do");
          
          DT_RG_ROOT=new TableColumn ("DT_RG_ROOT");
          DT_RG_ROOT.setCellValueFactory(new PropertyValueFactory<BVMpAkcDopunskaTreboArh,String>("rgRoot"));
 ...
 if ((tabela.getSelectionModel().getSelectedIndex()>-1)  )
   {
     ...
     String v_cmb_radnja;
        ...
        // v_id_artikla=Long.valueOf("-1");
        em.clear();
          List<BVMpAkcTrebovanjeArh>  results =  em.createNamedQuery("BVMpAkcTrebovanjeArh.findPretraga")
                  .setParameter("id", data.get(tabela.getSelectionModel().getSelectedIndex()).getId())
                  .setParameter("idArtikla", v_id_artikla)
          ...
          PP_ID.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,Integer>("id"));
          
          PP_ID_AKCIJE=new TableColumn ("PP_ID_AKCIJE");
          PP_ID_AKCIJE.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,Long>("idAkcije"));
          PP_ID_AKCIJE.setPrefWidth(90);
          PP_ID_AKCIJE.setText("id akcije"); 
          
          PP_ID_KAMPANJE=new TableColumn ("PP_ID_KAMPANJE");
          PP_ID_KAMPANJE.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("idKampanje"));
          PP_ID_KAMPANJE.setPrefWidth(90);
          PP_ID_KAMPANJE.setText("id kampanje"); 
          
          PP_ORGJED=new TableColumn ("PP_ORGJED");
          PP_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("orgjed"));
          PP_ORGJED.setPrefWidth(30);
          PP_ORGJED.setText("OJ"); 
          
          PP_NAZIV_ORGJED=new TableColumn ("PP_NAZIV_ORGJED");
          PP_NAZIV_ORGJED.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("ojNaziv"));
          PP_NAZIV_ORGJED.setPrefWidth(120);
          PP_NAZIV_ORGJED.setText("OJ naziv"); 
         
          PP_ARTIKAL=new TableColumn ("PP_ARTIKAL");
          PP_ARTIKAL.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,Long>("idArtikla"));
          PP_ARTIKAL.setPrefWidth(60);
          PP_ARTIKAL.setText("id artikla"); 
       
          PP_SIFRA=new TableColumn ("PP_SIFRA");
          PP_SIFRA.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("sifra"));
          PP_SIFRA.setPrefWidth(60);
          PP_SIFRA.setText("sifra art");
          
          PP_NAZIV=new TableColumn ("PP_NAZIV");
          PP_NAZIV.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("nazivArtikla"));
          PP_NAZIV.setPrefWidth(200);
          PP_NAZIV.setText("naziv artikla");
           
          PP_MAGACIN=new TableColumn ("PP_MAGACIN");
          PP_MAGACIN.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("magacin"));
          ...
          PP_OPIS.setCellValueFactory(new PropertyValueFactory<BVMpAkcTrebovanjeArh,String>("opis"));
...
*/
     ...
     public void kreirajExcelPreporuke() {
        ...
        // v_id_artikla=Long.valueOf("-1");
        em.clear();
          List<BVMpAkcPreporKolArh>  results_excel =  em.createNamedQuery("BVMpAkcPreporKolArh.filterPretraga")
                  .setParameter("id", data.get(tabela.getSelectionModel().getSelectedIndex()).getId())
                  .setParameter("naziv","%" +PK_P_naziv_artikla.getText().toUpperCase()+"%")
                  .setParameter("sifra","%" + PK_P_sifra.getText()+"%")
                  .setParameter("nazivOrgjed", v_cmb_radnja)
    ...
    System.out.println("greska je opsta: "+ex.getMessage());
     ...
     public void kreirajExcelDopuna() {
         ...
         try {
          ...
          List<BVMpAkcDopunskaTreboArh>  results_excel =  em.createNamedQuery("BVMpAkcDopunskaTreboArh.Pretraga")
                  .setParameter("id", data.get(tabela.getSelectionModel().getSelectedIndex()).getId())
                  .setParameter("nazivArtikla", "%"+DT_P_naziv_artikla.getText().toUpperCase()+"%")
                  .setParameter("sifra","%"+ DT_P_sifra.getText()+"%")
                  .setParameter("datOd", date1)
   ...
   try {       
    ...
    for (int i=0;i<results_excel.size();i++) {
        row = sheet.createRow(i+1); //IDE 
            ...
            cell = row.createCell(2);
            cell.setCellValue((Integer) results_excel.get(i).getIdArtikla());
            cell = row.createCell(3);
            cell.setCellValue((String) results_excel.get(i).getSifra());
            cell = row.createCell(4);
            ...
            if (results_excel.get(i).getZaliha()!= null)
            {
            cell = row.createCell(9);
            cell.setCellValue((Double) results_excel.get(i).getZaliha().doubleValue());
            }
            
            
            cell = row.createCell(10);
            cell.setCellValue((String) results_excel.get(i).getDatumZalihe());
     ...
     if (results_excel.get(i).getSredjenaKolicina() != null)       cell.setCellValue((Double) results_excel.get(i).getSredjenaKolicina().doubleValue());
            ...
            cell = row.createCell(16);
            cell.setCellValue((Double) results_excel.get(i).getProdaja().doubleValue());
...
System.out.println(dateFormat.format(date)); //2014/08/06 15:59:48
  ...
  String v_ime_fajla="AT-dopuna  "+dateFormat.format(date)+".xls";
    ...
    public void prikaziMatricuDopuna() {
           listaRazvozaDopuna(data.get(tabela.getSelectionModel().getSelectedIndex()).getId(),cmb_find_matrica_dop.getValue().toString());
    }
    ...
    @FXML public void izmeniPreporuku() {
      ...
      public void prikaziArtikleStop(Integer i)
      {
         ...
         List<BVMpAkcArtikStop>  results2 =  em.createNamedQuery("BVMpAkcArtikStop.findByIdAkcije")
          ...
          tbl_artikli_stop.getColumns().setAll(ART_STOP_ARTIKAL,ART_STOP_SIFRA,ART_STOP_NAZIV);
     
          tbl_artikli_stop.setItems(ART_STOP_data);
       ...
       /* public void obrisiArtikleStop() {
        try {
            if ((tbl_artikli_stop.getSelectionModel().getSelectedIndex()>-1)  )
    {
              em.getTransaction().begin();
             
        List<BMpAkcijePreporKol> b  =  em.createNamedQuery( "BMpAkcijePreporKol.findByArtikal")
               .setParameter("artikal", ART_STOP_data.get(tbl_artikli_stop.getSelectionModel().getSelectedIndex()).getArtikal())
               .getResultList();
       ...
       prikaziArtikleStop(data.get(tabela.getSelectionModel().getSelectedIndex()).getId());
            ...
            alert1.setHeaderText("Greška prilikom brisanja");
            alert1.setContentText("Greška je :  "+e.getMessage());
            alert1.showAndWait();
            em.getTransaction().rollback();
        }}*/
      
      public void obrisiJedanArtikalIZStop() {
        em.clear();
        try {
            if ((tbl_artikli_stop.getSelectionModel().getSelectedIndex() > -1)) {
                if(!(data.get(tabela.getSelectionModel().getSelectedIndex()).getStatus()).equals("Z")){
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("Brisanje");
                alert.setHeaderText("Da li zelite da obrisete selektovani red?");
                ...
                if (result.get() == ButtonType.OK) {
                      ...
                      em.getTransaction().begin();
          StoredProcedureQuery storedprocedure = em.createStoredProcedureQuery("ROUSER.B_MP_AKC_OBRISI_OBRADU_ZA1");
          ...
          storedprocedure.registerStoredProcedureParameter("p_artikal", Integer.class, ParameterMode.IN);
          storedprocedure.setParameter("p_artikal",ART_STOP_data.get(tbl_artikli_stop.getSelectionModel().getSelectedIndex()).getArtikal());
                ...
                Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
            alert1.setTitle("Error info");
            alert1.setHeaderText("Greška prilikom brisanja, status stop akcije je 'Z'");
            alert1.showAndWait();
                }
      ...
      @FXML
     public void kreirajExcelPrvoPunjenje() {
   ...
   try {      
    ...
    //kreiraj zaglavlje dokument
     row = sheet.createRow(0);
            ...
            cell = row.createCell(2);
            cell.setCellValue((String) "OJ_NAZIV");
           
             cell = row.createCell(3);
            cell.setCellValue((String) "MAGACIN");
           
            cell = row.createCell(4);
            cell.setCellValue((String) "ID_ARTIKLA");
           
           
           
            cell = row.createCell(5);
            cell.setCellValue((String) "SIFRA_ARTIKLA");
           
            cell = row.createCell(6);
            cell.setCellValue((String) "NAZIV_ARTIKLA");
           
             cell = row.createCell(7);
            cell.setCellValue((String) "SREDJENA_KOLICINA");
           
            cell = row.createCell(8);
            cell.setCellValue((String) "NABAVLJAM_KOL");
           
            cell = row.createCell(9);
            cell.setCellValue((String) "MF");
           
             cell = row.createCell(10);
            cell.setCellValue((String) "PREPOR_UK");
           
            cell = row.createCell(11);
            cell.setCellValue((String) "PREPOR");
           
           
           
            cell = row.createCell(12);
            cell.setCellValue((String) "SEKUND_POZ");
            ...
            cell = row.createCell(14);
            cell.setCellValue((String) "ID_AKCIJE");
    
    
            cell = row.createCell(15);
            cell.setCellValue((String) "ID_KAMPANJE");
    ...
    for (int i=0;i<results.size();i++) {
     ...
     //  GR_NAZIV,GR_VRED1,GR_VRED2,GR_VRED3,GR_VRED4,GR_VRED5,GR_VRED6,GR_VRED13,GR_VRED7,GR_VRED8,GR_VRED9,GR_VRED10,GR_VRED11,GR_VRED12
               ...
               if (results.get(i).getDatum() != null)
            {
            cell = row.createCell(0);
            cell.setCellValue((String) results.get(i).getDatum());
            }else
            {
            cell = row.createCell(0);
            ...
            if (results.get(i).getOrgjed().toString() != null)
            {
            cell = row.createCell(1);
            cell.setCellValue((String) results.get(i).getOrgjed().toString());
            }else
            {
            cell = row.createCell(1);
            cell.setCellValue((String) "/");
            ...
            if (results.get(i).getOjNaziv().toString() != null)
            {
            cell = row.createCell(2);
            cell.setCellValue((String) results.get(i).getOjNaziv().toString());
             }else
            {
            cell = row.createCell(2);
            cell.setCellValue((String) "/");
            ...
            if (results.get(i).getMagacin().toString() != null)
            {
            cell = row.createCell(3);
            cell.setCellValue((String) results.get(i).getMagacin().toString());
            }
            else
            {
            cell = row.createCell(3);
            ...
            if (results.get(i).getIdArtikla() != null)
            {
            cell = row.createCell(4);
            cell.setCellValue((String) results.get(i).getIdArtikla().toString());
            }
            else
            {
            cell = row.createCell(4);
            ...
            if (results.get(i).getSifra().toString() != null)
            {
            cell = row.createCell(5);
            cell.setCellValue((String)results.get(i).getSifra().toString());
             }
            else
            {
            cell = row.createCell(5);
            ...
            if (results.get(i).getNazivArtikla().toString() != null)
            {
            cell = row.createCell(6);
            cell.setCellValue((String)results.get(i).getNazivArtikla().toString());
             }
            else
            {
            cell = row.createCell(6);
            ...
            if (results.get(i).getSredjenaKolicina() != null)
            { 
            cell = row.createCell(7);
            cell.setCellValue((String) results.get(i).getSredjenaKolicina().toString());
            }else
            {
            cell = row.createCell(7);
            cell.setCellValue((String) "/");  
            ...
            if (results.get(i).getNabavljamKolicinu() != null)
            {
            cell = row.createCell(8);
            cell.setCellValue((String) results.get(i).getNabavljamKolicinu().toString());
            }
            else
            {
            cell = row.createCell(8);
            ...
            if (results.get(i).getMultifaktor() != null)
            {
            cell = row.createCell(9);
            cell.setCellValue((String) results.get(i).getMultifaktor().toString());
            }
            else
            {
            cell = row.createCell(9);
            ...
            if (results.get(i).getPreporucenaKolUk() != null)
            {
            cell = row.createCell(10);
            cell.setCellValue((String) results.get(i).getPreporucenaKolUk().toString());
            }
            else
            {
             cell = row.createCell(10);
            ...
            if (results.get(i).getPreporucenaKol() != null)
            {
            cell = row.createCell(11);
            cell.setCellValue((String) results.get(i).getPreporucenaKol().toString());
             }
            else
            {
            cell = row.createCell(11);
            ...
            if (results.get(i).getSekundarnaPozicija() != null)
            {
            cell = row.createCell(12);
            cell.setCellValue((String)results.get(i).getSekundarnaPozicija().toString());
            }
            else
            {
              cell = row.createCell(12);
            cell.setCellValue((String)"/"); 
             ...
             if (results.get(i).getZaliha() != null)
            {
            cell = row.createCell(13);
            cell.setCellValue((String)results.get(i).getZaliha().toString());
             }
            else
            {
            cell = row.createCell(13);
            ...
            cell = row.createCell(14);
            cell.setCellValue((String)results.get(i).getIdAkcije().toString());
           
           
           
             cell = row.createCell(15);
            cell.setCellValue((String)results.get(i).getIdKampanje().toString());
...
System.out.println(dateFormat.format(date)); //2014/08/06 15:59:48
  ...
  String v_ime_fajla="Izveštaj PRVO PUNJENJE  "+dateFormat.format(date)+".xls";
