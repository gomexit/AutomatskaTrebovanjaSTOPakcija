 ...
 * @author laki
 */
public class FXMLRucnePreporuke implements Initializable {
    ...
    @FXML   TableView tbl_lista_akcija; 
          ...
          TableColumn<BVMpAkcRucnePreporuke,Date> RP_SIS_DATUM;
           ObservableList<BVMpAkcRucnePreporuke> RP_data;
...
@FXML
          ...
          if ( proveriPodatke2().equals("OK"))
                            {
                                                            ...
                                                            */                                                                           
                                                              ...
                                                              em.getTransaction().begin();
                                                              StoredProcedureQuery storedprocedure1 = em.createStoredProcedureQuery("rouser.b_mp_akc_unesi_rucne_preporuke");
  ...
  public void prikaziRucnePreporuke() {
     ...
     */
     em.clear();
        List<BVMpAkcRucnePreporuke>  results =  em.createNamedQuery("BVMpAkcRucnePreporuke.findById")
              .setParameter("id", AK_data.get(tbl_lista_akcija.getSelectionModel().getSelectedIndex()).getId())
              .setHint(QueryHints.MAINTAIN_CACHE, "false")
                .getResultList();
          ...
          if ( proveriPodatke3().equals("OK"))
                            {
                                                            ...
                                                            */                                                                           
                                                              ...
                                                              em.getTransaction().begin();
                                                              StoredProcedureQuery storedprocedure1 = em.createStoredProcedureQuery("rouser.b_mp_akc_rucne_preporuke_izmen");
